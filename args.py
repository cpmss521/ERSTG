...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--dep_dim', type=int, default=50)
    arg_parser.add_argument('--bert_dropout', type=float, default=0.1)
    arg_parser.add_argument('--output_dropout', type=float, default=0.1)
    arg_parser.add_argument('--dep_num', type=int, default=45)  # 40 + 1(None) + 1(self-loop)
    arg_parser.add_argument('--num_layers', type=int, default=2)
    arg_parser.add_argument('--att_drop', type=float, default=0.0)
    arg_parser.add_argument('--dropout', type=float, default=0.1)
    arg_parser.add_argument('--heads', type=int, default=4)
    ...
    arg_parser.add_argument('--beta', type=float, default=1.0, help='weight for triaffine')
    arg_parser.add_argument('--alpha', type=float, default=1.0, help='weight for biaffine')


    # pos
    # arg_parser.add_argument('--use_pos', type=bool, default=True)
    arg_parser.add_argument('--pos_num', type=int, default=50)
    arg_parser.add_argument('--pos_dim', type=int, default=50)
    arg_parser.add_argument('--num_layer', type=int, default=2)
    arg_parser.add_argument('--w_size', type=int, default=5, help='the window size of local attention')

    # glove
    arg_parser.add_argument('--use_glove', action='store_true', default=False)
    arg_parser.add_argument('--word_dropout', type=float, default=0.4)
...
def train_argparser():
    ...
    arg_parser.add_argument('--over_rate', type=float, default=0.3,
                            help="overlap entity sample with ground true entity")
