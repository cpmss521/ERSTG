...
from EnRelTSG.entities import Document, Dataset, EntityType
from EnRelTSG.input_reader import BaseInputReader
from EnRelTSG.opt import jinja2

SCRIPT_PATH = os.path.dirname(os.path.realpath(__file__))


class Evaluator:
    def __init__(self, dataset: Dataset, input_reader: BaseInputReader, text_encoder: BertTokenizer, logger,
    ...
    def compute_scores(self):
        ...
        self._log("----------- Relations -----------")
        self._log("")
        self._log("Without named entity classification (NTC)")
        self._log("A relation is considered correct if the relation type and the spans of the two "
        ...
        self._log("")
        self._log("With named entity classification (NTC)")
        self._log("A relation is considered correct if the relation type and the two "
